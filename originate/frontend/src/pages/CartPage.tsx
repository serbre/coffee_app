    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <motion.div
          ...
          className="bg-coffee-900 border border-white/10 rounded-3xl p-8 shadow-2xl text-center max-w-md"
        >
    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex flex-col items-end justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="bg-accent-500/20 hover:bg-accent-500/30 text-accent-400 rounded p-1 transition-colors"
                      >
          ...
          >
            <div className="bg-coffee-900 border border-white/10 rounded-3xl p-6 shadow-2xl sticky top-24">
